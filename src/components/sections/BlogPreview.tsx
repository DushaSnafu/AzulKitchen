        ...
        <section id="blog" className="py-24 bg-[var(--color-brand-cream)] text-[var(--color-brand-blue)]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16">
                    ...
                    <Link href="/blog" className="hidden md:flex items-center gap-2 font-bold text-[var(--color-brand-green)] hover:text-[var(--color-brand-blue)] transition mt-4 md:mt-0">
                ...
                <Link href="/blog" className="md:hidden w-full flex justify-center items-center gap-2 font-bold text-[var(--color-brand-cream)] bg-[var(--color-brand-blue)] py-4 rounded-xl mt-12">
                    Voir tous les articles <ArrowRight className="w-5 h-5" />
                </Link>
            </div>
        </section>
